...
const experiences = [
	{
		...
		startDate: "Julu 2024",
		endDate: "Sept 2024",
		company: "Snow Programmers",
		position: "MERN Stack Intern",
		type: "Internship",
		location: "Skardu, Pakistan",
		description:
			"Gained hands-on experience with MERN stack technologies under the mentorship of senior developers by completing practical tasks and training modules in MERN, while strengthening skills in version control, API integration, and full-stack development best practices.",
		skills: ["MERN", "Algorithms", "Data Structures", "Project Coordination", "Jira", "Github", "Postman","Teamwork"],
	},
	{
		id: 2,
		startDate: "Oct 2024",
		...
		location: "Remote",
		description:
			"Translated Figma UI designs into functional, accessible interfaces using React.js and Next.js, developing modular components aligned with design systems. Collaborated with design and backend teams to ensure visual fidelity, seamless API integration, and delivered responsive, high-performance layouts optimized for both mobile and desktop platforms.",
		skills: [ "Frontend Integration", "Frontend Development", "Team Collaboration", "React.js", "Next.js" ],
	},
	{
		id: 3,
		...
		endDate: "Present",
		company: "Snow Programmers",
		position: "Software Developer (React + Typescript)",
		type: "Fulltime",
		location: "Skardu, Pakistan",
		description:
			"Crafted and maintained web applications using Reactjs and Typescript, ensuring high performance and responsiveness. Collaborated with designers and other  developers to create seamless user experiences on client projects.",
		skills: ["Mongodb", "Typescript", "Teamwork"],
	},
